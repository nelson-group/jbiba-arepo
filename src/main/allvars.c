...
#ifdef TURBULENCE
double turb_V, turb_zeta, turb_k_driv, turb_k_min, turb_k_max, turb_T, turb_dt, turb_ampl_coeff, turb_energy_input, turb_OUvar, turb_time;
double (*turb_OUphases)[3];
double *turb_nonzero_amplitudes; 
double (*turb_nonzero_k_modes)[3];
int turb_nonzero;
#endif