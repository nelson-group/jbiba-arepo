...
#ifdef TURBULENCE
  double turb_V, turb_zeta, turb_ampl_coeff;
#endif
...
#ifdef TURBULENCE
extern double turb_k_driv, turb_k_min, turb_k_max, turb_T, turb_dt, turb_energy_input, turb_OUvar, turb_time;
extern double (*turb_OUphases)[3];
extern double *turb_nonzero_amplitudes; 
extern double (*turb_nonzero_k_modes)[3];
extern int turb_nonzero;
#endif
